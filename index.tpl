...
{PRODUCER:}
	...
	{prodinfo:}Моделей: <b><a href="/catalog/{producer_nick}">{count}</a></b>, без цен: <b><a href="/catalog/{producer_nick}?m=:more.Цена.no=1">{Без цен}</a></b>, без картинок: <b><a href="/catalog/{producer_nick}?m=:more.images.no=1">{Без картинок}</a></b>, ошибки прайсов: <b><a href="/-showcase/producers/{producer_nick}">{Ошибки прайсов}</a></b>, {skip:skip}
{PRODUCERS:}
		{:menu}
		<h1>Производители</h1>
		{list::producer}
